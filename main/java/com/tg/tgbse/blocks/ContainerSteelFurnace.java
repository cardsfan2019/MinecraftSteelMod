...
public class ContainerSteelFurnace extends Container
{
	...
	public ContainerSteelFurnace(InventoryPlayer player, TileEntitySteelFurnace tileentity) 
	{
		...
		if (handler != null) {
			this.addSlotToContainer(new SlotItemHandler(handler, 0, 45, 17));
			this.addSlotToContainer(new SlotItemHandler(handler, 1, 66, 17));
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) 
	{
		...
		if(slot != null && slot.getHasStack()) 
		{
			...
			{		
				...
				if(TileEntitySteelFurnace.isItemIngredient(slot1.getStack())) {
				...
				} else if(TileEntitySteelFurnace.isItemFuel(slot1.getStack())) {
